...
var firstDay = new Date(today.getFullYear(), month - 1, 1).getDay(); //1일 요일 구하기
var lastDay = new Date(today.getFullYear(), month, 0).getDate(); //마지막 날짜 구하기

var tableNode = document.querySelector(".calendarTable"); //<table> 노드 가져오기
var tbodyNode = document.querySelector(".tbodyClass");
